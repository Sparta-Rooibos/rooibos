...
import com.sparta.rooibos.deliverer.application.exception.custom.CommonErrorCode;
import com.sparta.rooibos.deliverer.presentation.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // 비즈니스 예외
    @ExceptionHandler(BusinessDelivererException.class)
    public ResponseEntity<ErrorResponse> handleCustomException(BusinessDelivererException e) {
        log.warn("error :", e);
