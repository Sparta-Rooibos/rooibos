...
import com.sparta.rooibos.message.application.custom.CommonErrorCode;
import com.sparta.rooibos.message.application.exception.BusinessMessageException;
import com.sparta.rooibos.message.presentation.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomException(BusinessMessageException e) {
