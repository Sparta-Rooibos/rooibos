...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleException(Exception e) {
        ...
        return new ResponseEntity<>(new ErrorResponse(ClientErrorCode.INTERNAL_SERVER_ERROR.getCode(), e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<?> handleSqlBadRequestException(BadSqlGrammarException e) {
        ...
        return new ResponseEntity<>(new ErrorResponse(ClientErrorCode.SQL_ERROR.getCode(), e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        return new ResponseEntity<>(new ErrorResponse(ClientErrorCode.JSON_PARSING_ERROR.getCode(), e.getMessage()), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<?> handleNoHandlerFoundException(NoResourceFoundException e) {
        ...
        return new ResponseEntity<>(new ErrorResponse(ClientErrorCode.RESOURCE_NOT_FOUND.getCode(), e.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<?> handleHttpMessageNotReadableException(MethodArgumentNotValidException e) {
        ...
        final FieldError fieldError = e.getFieldErrors()
                ...
                .get();
        return new ResponseEntity<>(new ErrorResponse(ClientErrorCode.INVALID_CODE.getCode(), fieldError.getField() + ": " + fieldError.getDefaultMessage()), HttpStatus.BAD_REQUEST);
    }
