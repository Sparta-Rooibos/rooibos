...
public record SearchProductRequestDto(UUID id, String name, Boolean isDeleted, String sort, Integer page,
                                      Integer size) {
    ...
    public SearchProductRequest toApplication(Pageable pageable) {
        return new SearchProductRequest(id, name, isDeleted, pageable);
    }
}
