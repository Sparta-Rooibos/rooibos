...
//
//    private final RedisTemplate<String, CachedUserResponse> userCacheRedisTemplate;
//
//    @Bean
...
//
//            CachedUserResponse dto = new CachedUserResponse(username, email, password, role);
//
...
//
//
//            CachedUserResponse hubdto = new CachedUserResponse(hubusername, hubemail, hubpassword, hubrole);
...
//
//
//            CachedUserResponse deliverydto = new CachedUserResponse(deliveryusername, deliveryemail, deliverypassword, deliveryrole);
...
//
//
//            CachedUserResponse clientdto = new CachedUserResponse(clientusername, clientemail, clientpassword, clientrole);
